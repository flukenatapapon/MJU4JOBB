...
/**
 * Servlet implementation class AdminUpdateTServlet
 */
@WebServlet("/AdminUpdateTServlet")
public class AdminUpdateTServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUpdateTServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			session.setAttribute("adupt", rts);
			session.setAttribute("uid",id);
			System.out.println(rt.getIdRegister());
			goTo("/UpdateAdminT.jsp",request,response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Register re = new Register(id,1,gender,position,prefix,fullname,nickname,tell,"",travelType,travelVehicle,travelDetail,travelTypeR,travelVehicleR,travelDetailR,foodtype,foodallegy,pic,"","",f);
