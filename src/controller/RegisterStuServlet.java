...
//     		int d = 16; จํานวน input ทีมีก่อนเพิ่ม 
//     		 10 ตือจํานวนที input เพิ่มเข้ามา
//     		for(int k = 0; k < 10 ; k++) {
//     			researcher[k] = items.get(d).getString("UTF-8");
//     			d++;
//     		}
            ...
            String path = request.getServletContext().getRealPath("/")+"//Upload//" ; 
        		...
        		Register re = new Register("",2,gender,position,prefix,fullname,nickname,tell,"",travelType,travelVehicle,travelDetail,travelTypeR,travelVehicleR,travelDetailR,foodtype,foodallegy,pic,"","",f);
