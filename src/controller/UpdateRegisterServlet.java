...
public class UpdateRegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			goTo("/UpdateRegisterT.jsp",request,response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RegisManager rm = new RegisManager();
		if(faculty.equals("15") || faculty.equals("16") || faculty.equals("17")) {
			rm.updateRegisterS(re);
			response.sendRedirect("main.jsp");
		}else {
			session.setAttribute("chhss", "1");
			response.sendRedirect("UpdateRegisterActivity.jsp");
		}
