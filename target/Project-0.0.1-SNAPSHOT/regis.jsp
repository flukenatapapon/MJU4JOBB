...
<html lang="en">
  <head>
    ...
    <title>แบบฟอร์มสมัครเข้าร่วมกิจกรรม</title>
      ...
      <div class="row">
        <div class="col-md-6 col-sm-8 col-xs-12 col-md-offset-3 col-sm-offset-2">
          <div class="register-form">
            <form action="RegisterTeacServlet" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-12 col-xs-12">
                 ...
                 <p style="color:black"> ตําแหน่ง : </p> 
                 	<input type="radio" name="position" required="required" value="บริหาร"> บริหาร
                	<input type="radio" name="position" required="required" value="วิชาการ"> วิชาการ
              	</div>
              ...
              <p> รายละเอียดการเดินทางกลับ : </p> 
                ...
                <input type="text" name="travelDetailR" class="form-control" placeholder=" รายละเอียดการเดินทางกลับ " >
              </div>
              <div class="form-group col-sm-12">
              <p> อาหาร  : </p> 
