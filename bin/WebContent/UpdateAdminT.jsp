...
<%
	...
	if(null == login){
		...
		String user = (String) session.getAttribute("adupt");
      ...
      <div class="row">
        <div class="col-md-10" style="margin-left:8%;">
          <div class="register-form">
            <form action="AdminUpdateTServlet" style=" margin:0 auto; " method="post" enctype="multipart/form-data">
			<h2 class="text-center" style="color:black"> แบบฟอร์มสมัครเข้าร่วมกิจกรรม (อาจารย์) </h2>
              ...
              <p style="color:black"> มหาวิทยาลัย  : </p> 
                <input type="text" name="university" class="form-control" values="<%= uuaa %>" placeholder="<%= uuaa %>" readonly>
              </div>
              <div class="form-group col-sm-4">
              ...
              <% if(re.getTraveling().equals("รถยนต์ส่วนตัว")){ %> 
                ...
                <% } %>
                <textarea rows="4" cols="50" name="travelDetail" class="form-control" placeholder=" รายละเอียดการเดินทาง "><%= re.getTravel() %></textarea>
