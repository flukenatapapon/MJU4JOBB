...
<html lang="en">
  ...
  <link rel="icon" href="image/logo-2.png" type="image/png" sizes="16x16">
    ...
    <title>แบบฟอร์มการเข้าร่วมกิจกรรม (นักศึกษา)</title>
      ...
      <div class="row">
        <div class="col-md-10 register-form" style="margin-left:8%;">
         <h2 class="text-center" style="color:black"> แบบฟอร์มสมัครเข้าร่วมกิจกรรม (นักศึกษา) </h2>
          <div >
            <form action="RegisterStuServlet" style="margin:0 auto; " name="frm" method="post" enctype="multipart/form-data">
              ...
              <p style="color:black"> รายละเอียดการเดินทางมามหาวิทยาลัยแม่โจ้  : </p> 
              	<input type="radio" name="travelVehicle" value="รถบัส" checked> รถบัส
                <input type="radio" name="travelVehicle" value="รถไฟ">  รถไฟ
 				<textarea rows="4" cols="80" name="travelDetail" id="travelDetail" class="form-control" placeholder=" รายละเอียดการเดินทาง " ></textarea>
              ...
              <p style="color:black"> รายละเอียดการเดินทางกลับ  : </p> 
              	<input type="radio" name="travelVehicleR" value="รถบัส" checked> รถบัส
                <input type="radio" name="travelVehicleR" value="รถไฟ">  รถไฟ
 				<textarea rows="4" cols="80" name="travelDetailR" id="travelDetailR" class="form-control" placeholder=" รายละเอียดการเดินทาง "></textarea>
